...
declare module 'expo-router' {
  export namespace ExpoRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      StaticRoutes: `/` | `/(tabs)` | `/(tabs)/` | `/(tabs)/history` | `/(tabs)/league` | `/(tabs)/players` | `/(tabs)/projections` | `/(tabs)/settings` | `/(tabs)/trades` | `/_sitemap` | `/buy-ins` | `/commissioner\` | `/commissioner\_layout` | `/commissioner\cap` | `/commissioner\history` | `/commissioner\roster` | `/commissioner\rules` | `/commissioner\teams` | `/commissioner\trade` | `/history` | `/league` | `/league-history` | `/players` | `/projections` | `/rules` | `/settings` | `/trade/new` | `/trades`;
